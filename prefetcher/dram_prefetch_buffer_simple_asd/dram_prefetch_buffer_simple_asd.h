#ifndef PREFETCHER_DRAM_BUFFER_SIMPLE_ASD_H
#define PREFETCHER_DRAM_BUFFER_SIMPLE_ASD_H
...
struct dram_prefetch_buffer_simple_asd : public champsim::modules::prefetcher {
  ...
  constexpr static std::size_t MAX_DEPTH = 4;
