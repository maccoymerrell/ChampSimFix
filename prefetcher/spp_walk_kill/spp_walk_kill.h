...
struct spp_walk_kill : public champsim::modules::prefetcher {
  ...
  std::map<champsim::block_number,bool> used_map_l2c;
  std::map<champsim::block_number,bool> used_map_llc;
  ...
  public:
    ...
    bool check(champsim::address pf_addr, FILTER_REQUEST filter_request, bool& kill);
  };
