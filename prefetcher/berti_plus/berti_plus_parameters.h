# ifndef _BERTI_PLUS_PARAMETERS_H_
# define _BERTI_PLUS_PARAMETERS_H_

// ChampSim's modular build no longer exposes global BLOCK_SIZE / LOG2_BLOCK_SIZE
// macros (modules read block_size from the config). Berti+ uses these in
// compile-time constexpr contexts, so define them here for the standard 64-byte
// cache line used by all DPC4 traces.
