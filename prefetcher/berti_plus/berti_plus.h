#ifndef BERTI_PLUS_H_
#define BERTI_PLUS_H_
...
#include "berti_plus_parameters.h"
#include "cache.h"
...
class berti_plus : public champsim::modules::prefetcher {
    ...
    sppam_b_util::msl::lru_table<region_type,region_indexer,region_indexer> region_history_table{BERTI_REGION_HISTORY_SETS,BERTI_REGION_HISTORY_WAYS};
    sppam_b_util::msl::lru_table<region_coverage_type,region_coverageindexer,region_coverageindexer> region_coverage_table{BERTI_REGION_COVERAGE_SETS,BERTI_REGION_COVERAGE_WAYS};
    ...
    champsim::page_number prev_stream_page = champsim::page_number{};
