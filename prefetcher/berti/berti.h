...
public:
  ...
  explicit berti(champsim::modules::ModuleBuilder builder);

private:
  // The parent cache, captured at construction (dynamic state queries: current
  // cycle, PQ occupancy). intern_ is private in the runtime base class.
