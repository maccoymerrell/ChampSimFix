...
class ZEN4 final : public IAddrMapper, public Implementation {
  ...
  class ZEN4_AFTER_CHANNEL final : public IAddrMapper, public Implementation {
    RAMULATOR_REGISTER_IMPLEMENTATION(IAddrMapper, ZEN4_AFTER_CHANNEL, "ZEN4_AFTER_CHANNEL", "Applies a ZEN4 mapping to the address");
  ...
  class ZEN4_AFTER_BANKGROUP final : public IAddrMapper, public Implementation {
    RAMULATOR_REGISTER_IMPLEMENTATION(IAddrMapper, ZEN4_AFTER_BANKGROUP, "ZEN4_AFTER_BANKGROUP", "Applies a ZEN4 mapping to the address");
  ...
  class ZEN4_AFTER_BANK final : public IAddrMapper, public Implementation {
    RAMULATOR_REGISTER_IMPLEMENTATION(IAddrMapper, ZEN4_AFTER_BANK, "ZEN4_AFTER_BANK", "Applies a ZEN4 mapping to the address");
